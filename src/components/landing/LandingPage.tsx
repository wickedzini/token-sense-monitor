  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <Button className="bg-gray-900 text-white font-semibold rounded-lg px-5 py-2 shadow-md hover:bg-gray-800 transition" asChild>
                  <Link href="/login">Log in</Link>
                </Button>
                <Button className="bg-brand-primary text-white font-semibold rounded-lg px-5 py-2 shadow-md hover:bg-brand-dark transition" asChild>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4">
                <Button className="bg-gray-900 text-white text-lg font-bold rounded-lg py-6 px-8 shadow-md hover:bg-gray-800 transition animate-enter" size="lg" asChild>
                  <Link href="/signup">Start Free Trial</Link>
                </Button>
                <Button className="bg-white text-gray-900 border border-gray-300 text-lg font-semibold rounded-lg py-6 px-8 shadow hover:bg-gray-100 transition animate-enter" style={{ animationDelay: "0.2s" }} size="lg" onClick={() => setVideoOpen(true)}>
                  Watch Demo
                </Button>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {suggestions.map((suggestion, index) => (
              <Card key={index} className="shadow-sm hover:shadow-md transition-shadow duration-300 border-gray-200 overflow-hidden flex flex-col">
                <CardHeader className="pb-2 bg-gray-50 border-b">
                  <div className="flex items-center justify-between mb-2">
                    {suggestion.icon}
                    <Badge variant="outline" className="border border-gray-900 bg-white text-gray-900 px-2 py-0.5 rounded-full text-xs font-medium">
                      {suggestion.savings}
                    </Badge>
                  </div>
                ...
                <CardContent className="pt-4 flex-grow">
                  ...
                  <div className="flex gap-2 mt-3">
                    {suggestion.tags.map((tag, i) => (
                      <span key={i} className="inline-block bg-blue-500 text-white px-2 py-0.5 rounded-full text-xs font-medium">
                        {tag}
                      </span>
                    ))}
                  </div>
                </CardContent>
                <CardFooter className="border-t pt-3 bg-gray-50 mt-auto">
                  <Button variant="link" className="text-brand-primary p-0" asChild>
                    <Link href="/login">View detail <ChevronRight className="h-4 w-4 ml-1" /></Link>
                  </Button>
                </CardFooter>
              </Card>
            ))}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="shadow-sm hover:shadow-md transition-all duration-300 hover:translate-y-[-5px] p-6">
            ...
            <Card className="shadow-sm hover:shadow-md transition-all duration-300 hover:translate-y-[-5px] p-6">
              ...
              <CardContent className="pt-0">
                <p className="text-gray-600">Integrate with all major LLM providers including OpenAI, Anthropic, Cohere, AI21, Google Gemini, and self-hosted models.</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50" id="pricing">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-brand-primary text-white px-3 py-1">Save up to 20% annually</Badge>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="flex flex-col relative border-brand-primary">
              ...
              <CardFooter className="mt-auto pt-4">
                <Button className="w-full bg-brand-primary hover:bg-brand-dark text-white">
                  Start saving today
                </Button>
              </CardFooter>
            </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button variant="outline" className="text-brand-primary" size="lg" asChild>
