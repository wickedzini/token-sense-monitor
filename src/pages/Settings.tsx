...
import { Eye, EyeOff, Key, UploadCloud, Slack } from "lucide-react";
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="grid gap-3">
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <Input id="slack-webhook" type="text" placeholder="https://hooks.slack.com/services/..." />
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Card className="border-2 border-transparent hover:border-brand-primary/20 transition-all">
                    <CardHeader>
                  ...
                  <Card className="border-2 border-brand-primary/30 shadow-lg">
                    <CardHeader>
                      <div className="flex items-center justify-between">
