  ...
  return (
    <div className="container py-12 px-4 mx-auto">
      ...
      <div id="compare" className="mt-16">
        <h2 className="text-2xl font-display font-bold text-center mb-8">Compare Plans</h2>
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-gray-600 mb-6">
            Contact our sales team for a plan tailored to your specific requirements.
          </p>
